...
uint256 hashGenesisBlock("0x7ee4d7430779afd89b6d6402712c55c024725f4b085f9755f96b4b740c184345");
...
static const int64 nTargetTimespan = 10 * 30 ; // Maxcoin: 5mintues
static const int64 nTargetSpacing = 1 * 30; // Maxcoin: 30 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7ee4d7430779afd89b6d6402712c55c024725f4b085f9755f96b4b740c184345");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is a new start";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1515842760;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1072168;
	...
	assert(block.hashMerkleRoot == uint256("0x4bb8cd4f9db79a7e9384ebcbb9455c72529d0070bc6a37eac6540a4852d446d8"));
